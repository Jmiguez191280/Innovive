...
<div class="quick-add-box">
	<form novalidate action="#">
		...
		<div class="quick-add-box-right" data-input="quickaddSearch" data-validation="control-group">
			...
			<input style="width:25%" type="text"  id="case-quantity" class="quick-add-box-right-quantity-value" min="" disabled>

			<label for="quantity" class="quick-add-input-quantity">Case Quantity:</label>
