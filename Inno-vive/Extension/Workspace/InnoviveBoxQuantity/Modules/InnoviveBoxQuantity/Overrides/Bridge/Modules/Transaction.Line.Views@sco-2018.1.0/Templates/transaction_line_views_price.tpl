...
<div class="transaction-line-views-price">
	<span class="transaction-line-views-price-exact" itemprop="offers" itemscope itemtype="https://schema.org/Offer">
		...
		<span class="transaction-line-views-price-lead" itemprop="price" data-rate="{{multiply price model.item.custitem_qty_per_box}}">
			{{multiplyFormatted price model.item.custitem_qty_per_box}}*
	</span>
		{{#if showComparePrice}}
