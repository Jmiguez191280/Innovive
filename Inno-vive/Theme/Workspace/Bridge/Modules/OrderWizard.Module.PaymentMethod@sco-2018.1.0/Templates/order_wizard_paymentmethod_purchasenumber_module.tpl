...
<div class="order-wizard-paymentmethod-purchasenumber-module">
	...
	<div class="order-wizard-paymentmethod-purchasenumber-module-row" data-input="purchase-order-number" data-validation="control-group">
		<label for="purchase-order-number" class="order-wizard-paymentmethod-purchasenumber-module-purchase-order-label">
			{{translate 'Enter Purchase Order Number R'}} <span class="order-wizard-paymentmethod-purchasenumber-module-purchase-order-required"> {{ translate '(Required)' }} </span>
		</label>
